...
class HANLayer(nn.Module):
    ...
    def __init__(self, num_meta_paths, in_size, out_size, layer_num_heads, dropout):
        ...
        :param num_meta_paths: number of homogeneous graphs generated from the meta-paths
    ...
    def __init__(self, num_meta_paths, in_size, hidden_size, out_size, num_heads, dropout):
        ...
        for l in range(1, len(num_heads)):
            self.layers.append(HANLayer(
                num_meta_paths, hidden_size * num_heads[l - 1], hidden_size, num_heads[l], dropout
            ))
